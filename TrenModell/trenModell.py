...
data_path = 'TrenModell/Treningsdata/alpha12.txt'
Text= []
Labels = []
...
utgangsmodell.save("modeller/alpha12") #https://discuss.huggingface.co/t/how-to-save-my-model-to-use-it-later/20568