...
data_path = 'TrenModell/Treningsdata/alpha11.txt'
Text= []
Labels = []
...
utgangsmodell.save("modeller/alpha11") #https://discuss.huggingface.co/t/how-to-save-my-model-to-use-it-later/20568